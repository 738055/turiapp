...
export type StoreTemplateCategory = StoreTemplate["category"];

export const STORE_TEMPLATE_GROUPS: {
  category: StoreTemplateCategory;
  label: string;
  description: string;
}[] = [
  { category: "multi", label: "Multiuso", description: "Bases rapidas para lojas pequenas ou mistas." },
  { category: "receptivo", label: "Receptivo", description: "Passeios locais, transfers, ingressos, atrativos e experiencias." },
  { category: "emissivo", label: "Emissivo", description: "Pacotes, cruzeiros, viagens em grupo e roteiros sob medida." },
  { category: "hospedagem", label: "Hospedagem", description: "Pousadas, hoteis, chales, temporada e day use." },
];
...
export const STORE_TEMPLATES: StoreTemplate[] = [
  ...
  {
    id: "receptivo-ingressos",
    name: "Ingressos & Atrativos",
    category: "receptivo",
    description: "Modelo direto para vender ingressos, parques, atrativos, combos e experiencias com entrada marcada.",
    source: "references/projetos-base/receptivo - variante ingressos",
    bestFor: ["parques", "ingressos", "atrativos", "combos"],
    theme: {
    ...
    sections: [
      hero("Ingressos e atrativos com compra facil", "Mostre validade, regras, horarios, inclusos e combos para o cliente comprar sem depender de explicacao manual.", "Comprar ingressos", "/busca?modulo=receptivo", "https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?auto=format&fit=crop&w=1600&q=80", "marketplace", [
        { value: "QR", label: "voucher digital" },
        { value: "combo", label: "atrativos juntos" },
        { value: "rapido", label: "compra simples" },
      ]),
      searchBar("Busque por parque, atrativo ou combo"),
      productGrid("Ingressos mais procurados", "Cards com preco forte, regras claras, validade e informacoes importantes.", "receptivo", "marketplace"),
    ...
    productDefaults: productDefaults("receptivo", "ingresso", {
      title: "Ingresso parque aventura",
      description: "Ingresso para atrativo com regras claras, validade informada e suporte de atendimento.",
      extra_data: {
        duration: "Validade diaria",
        location: "Parque / atrativo",
        highlights: ["Voucher digital", "Regras claras", "Compra rapida"],
        included: ["Entrada no atrativo", "Orientacoes de uso", "Suporte da equipe"],
        not_included: ["Transporte", "Alimentacao", "Extras opcionais"],
      },
    }),
  },
  {
    id: "receptivo-transfer-executivo",
    name: "Transfer Executivo",
    category: "receptivo",
    description: "Tema operacional para transfers, motorista privativo, receptivo aeroportuario e transporte corporativo.",
    source: "references/projetos-base/receptivo2 - variante transporte",
    bestFor: ["transfers", "motorista privativo", "aeroporto", "corporativo"],
    theme: {
    ...
    sections: [
      hero("Transfers pontuais para sua operacao", "Venda traslados, receptivo aeroportuario, motorista privativo e logistica para eventos com uma apresentacao confiavel.", "Solicitar transfer", "/busca?modulo=receptivo", "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&w=1600&q=80", "marketplace", [
        { value: "24h", label: "agendamento" },
        { value: "privativo", label: "opcoes exclusivas" },
        { value: "evento", label: "logistica em grupo" },
      ]),
      productGrid("Servicos de transporte", "Cards horizontais valorizam rota, capacidade, tipo de veiculo e preco.", "receptivo", "marketplace"),
      about("Transporte precisa transmitir seguranca", "Este modelo prioriza clareza operacional: ponto de encontro, horarios, capacidade, bagagem, rota e atendimento."),
      banner("Atenda eventos e grupos", "Capture demandas de empresas, agencias parceiras e grupos que precisam de logistica dedicada.", "Pedir cotacao", "/contato", "#164e63"),
      faq([
        { question: "Posso vender por rota?", answer: "Sim. Cadastre cada rota como produto e use tarifas por grupo, pessoa ou fixas." },
        { question: "Consigo atender grupos?", answer: "Sim. Use cotacoes e WhatsApp para demandas personalizadas de evento ou grupo." },
      ]),
      contact(),
      footer("Transfers, transporte privativo e receptivo com operacao organizada."),
    ],
    productDefaults: productDefaults("receptivo", "transporte", {
      title: "Transfer aeroporto hotel",
      description: "Transporte privativo com motorista, ponto de encontro definido e atendimento pontual.",
      extra_data: {
        duration: "1 hora",
        location: "Aeroporto / hotel",
        highlights: ["Motorista privativo", "Horario combinado", "Suporte no embarque"],
        included: ["Veiculo privativo", "Motorista", "Monitoramento do horario"],
        not_included: ["Pedagios se nao descritos", "Paradas extras", "Excesso de bagagem"],
      },
    }),
  },
  {
    id: "emissivo-excursoes",
    name: "Excursoes Rodoviarias",
    category: "emissivo",
    description: "Modelo popular e comercial para excursoes, viagens rodoviarias, bate-volta e saidas com coordenador.",
    source: "references/projetos-base/receptivo2 adaptado para excursoes",
    bestFor: ["excursoes", "bate-volta", "rodoviario", "grupos populares"],
    theme: {
    ...
    sections: [
      hero("Excursoes prontas para lotar o onibus", "Divulgue datas, embarques, roteiro, inclusos e formas de pagamento com linguagem direta para conversao.", "Ver proximas saidas", "/busca?modulo=emissivo", "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=1600&q=80", "marketplace", [
        { value: "saida", label: "datas programadas" },
        { value: "embarque", label: "pontos definidos" },
        { value: "grupo", label: "coordenador" },
      ]),
      searchBar("Busque por destino, data ou ponto de embarque"),
      productGrid("Proximas excursoes", "Produtos com roteiro, pontos de embarque, inclusos e condicoes de pagamento.", "emissivo", "marketplace"),
      banner("Crie senso de urgencia nas vagas", "Use banners para chamadas de ultimas vagas, lotes e datas especiais.", "Falar no WhatsApp", "/contato", "#7c2d12"),
      testimonials([
        { name: "Sandra Reis", rating: 5, text: "Ficou facil entender horario, embarque e o que estava incluso." },
        { name: "Joao Pedro", rating: 5, text: "A pagina ajudou a decidir rapido e chamar no WhatsApp." },
        { name: "Grupo Alegria", rating: 5, text: "Ideal para divulgar varias saidas sem confundir o cliente." },
      ]),
      faq(),
      contact(),
      footer("Excursoes e grupos com datas, roteiro e atendimento bem organizados."),
    ],
    productDefaults: productDefaults("emissivo", "pacote", {
      title: "Excursao bate-volta",
      description: "Saida rodoviaria em grupo com roteiro, pontos de embarque e coordenador.",
      extra_data: {
        duration: "1 dia",
        location: "Destino regional",
        highlights: ["Pontos de embarque", "Coordenador de grupo", "Pagamento facilitado"],
        included: ["Transporte rodoviario", "Coordenador", "Roteiro descrito"],
        not_included: ["Almoco", "Ingressos opcionais", "Despesas pessoais"],
      },
    }),
  },
  {
    id: "emissivo-estudos",
    name: "Intercambio & Estudos",
    category: "emissivo",
    description: "Tema consultivo para intercambio, cursos, programas de estudo, imersoes e experiencias internacionais.",
    source: "references/projetos-base/receptivo3 adaptado para estudos",
    bestFor: ["intercambio", "cursos", "imersoes", "programas internacionais"],
    theme: {
    ...
    sections: [
      hero("Programas internacionais com orientacao clara", "Apresente cursos, duracao, requisitos, destinos e suporte para transformar interessados em leads qualificados.", "Conhecer programas", "/busca?modulo=emissivo", "https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?auto=format&fit=crop&w=1600&q=80", "marketplace", [
        { value: "curso", label: "programas por perfil" },
        { value: "visto", label: "orientacoes" },
        { value: "lead", label: "consultoria" },
      ]),
      productGrid("Programas em destaque", "Cards explicam destino, duracao, perfil ideal, inclusos e proximos passos.", "emissivo", "marketplace"),
      about("Venda orientacao, nao apenas pacote", "O modelo ajuda a explicar requisitos, beneficios, suporte documental e atendimento consultivo para familias e estudantes."),
      banner("Capture interessados para consultoria", "Leve o usuario para contato quando o programa exige analise de perfil.", "Agendar conversa", "/contato", "#1e293b"),
      faq([
        { question: "Posso listar requisitos do programa?", answer: "Sim. Use informacoes importantes, roteiro e campos de descricao do produto." },
        { question: "Serve para cursos no Brasil?", answer: "Sim. O modelo funciona para imersoes, cursos livres e programas educacionais." },
      ]),
      contact(),
      footer("Programas de estudo e viagens educacionais com atendimento consultivo."),
    ],
    productDefaults: productDefaults("emissivo", "viagem", {
      title: "Programa de intercambio",
      description: "Programa educacional com orientacao consultiva, detalhes de duracao, destino e requisitos.",
      extra_data: {
        duration: "4 semanas",
        location: "Destino internacional",
        highlights: ["Consultoria inicial", "Escola parceira", "Orientacao documental"],
        included: ["Curso conforme programa", "Suporte da agencia", "Orientacoes pre-embarque"],
        not_included: ["Passagens", "Visto", "Seguro se nao descrito"],
      },
    }),
  },
  {
    id: "hospedagem-executiva",
    name: "Hotel Executivo",
    category: "hospedagem",
    description: "Modelo sobrio para hoteis urbanos, hospedagem corporativa, eventos, salas e estadias de negocios.",
    source: "references/projetos-base/hospedagem - variante corporativa",
    bestFor: ["hotel urbano", "corporativo", "eventos", "business travel"],
    theme: {
      primary_color: "#334155",
    ...
    sections: [
      hero("Hospedagem eficiente para negocios", "Apresente quartos, tarifas corporativas, salas, cafe da manha, localizacao e facilidades para viajantes a trabalho.", "Ver quartos", "/busca?modulo=hospedagem", "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1600&q=80", "editorial", [
        { value: "wifi", label: "estrutura para trabalho" },
        { value: "centro", label: "boa localizacao" },
        { value: "empresa", label: "tarifas corporativas" },
      ]),
      productGrid("Quartos e solucoes", "Cards claros para diaria, capacidade, comodidades e politica comercial.", "hospedagem", "editorial"),
      about("Clareza para viajantes corporativos", "Use este modelo para destacar localizacao, facilidades, salas, estacionamento, cafe e condicoes para empresas."),
      banner("Tarifas para empresas e eventos", "Capture pedidos recorrentes e negociacoes corporativas.", "Solicitar proposta", "/contato", "#0f172a"),
      faq([
        { question: "Posso destacar tarifas corporativas?", answer: "Sim. Use produtos, tarifas e secoes para explicar condicoes comerciais." },
        { question: "Serve para salas e eventos?", answer: "Sim. Cadastre salas ou experiencias como produtos e use cotacao para demandas maiores." },
      ]),
      contact(),
      footer("Hotelaria urbana, eventos e estadias corporativas com informacao objetiva."),
    ],
    productDefaults: productDefaults("hospedagem", "hotel", {
      title: "Quarto executivo",
      description: "Acomodacao pratica para negocios, com estrutura de trabalho e excelente localizacao.",
      extra_data: {
        duration: "Diarias corporativas",
        location: "Centro / regiao empresarial",
        highlights: ["Mesa de trabalho", "Wi-Fi rapido", "Cafe da manha"],
        included: ["Wi-Fi", "Cafe da manha", "Roupa de cama e banho"],
        not_included: ["Estacionamento se nao descrito", "Consumo extra", "Sala de reuniao"],
        capacity: "2 pessoas",
        bedrooms: "1 quarto",
        bathrooms: "1 banheiro",
      },
  ...
  {
    id: "hospedagem-temporada",
    name: "Temporada Familiar",
    category: "hospedagem",
    description: "Modelo caloroso para casas de temporada, apartamentos, familias, grupos e hospedagens completas.",
    source: "references/projetos-base/hospedagem - variante temporada",
    bestFor: ["casas de temporada", "apartamentos", "familias", "grupos"],
    theme: {
    ...
    sections: [
      hero("Sua casa de temporada pronta para reservar", "Valorize espaco, comodidades, regras da casa, capacidade e fotos para familias decidirem com seguranca.", "Ver opcoes", "/busca?modulo=hospedagem", "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1600&q=80", "editorial", [
        { value: "familia", label: "espaco completo" },
        { value: "cozinha", label: "comodidades claras" },
        { value: "grupo", label: "capacidade definida" },
      ]),
      productGrid("Casas e apartamentos", "Mostre capacidade, quartos, banheiros, regras, inclusos e politicas para reserva.", "hospedagem", "editorial"),
      about("Detalhes que reduzem duvidas", "O layout ajuda a explicar regras da casa, utensilios, localizacao, capacidade e tudo que uma familia precisa saber antes de reservar."),
      banner("Datas especiais e feriados", "Destaque disponibilidade, pacotes de temporada e estadias longas.", "Consultar disponibilidade", "/contato", "#0f766e"),
      testimonials([
        { name: "Familia Almeida", rating: 5, text: "Conseguimos ver capacidade, fotos e regras antes de chamar." },
        { name: "Camila Torres", rating: 5, text: "A pagina passou seguranca para fechar a estadia." },
        { name: "Grupo Martins", rating: 5, text: "Foi facil comparar casas para nosso grupo." },
      ]),
      faq(),
      contact(),
      footer("Casas, apartamentos e estadias de temporada com apresentacao acolhedora."),
    ],
    productDefaults: productDefaults("hospedagem", "airbnb", {
      title: "Casa completa para familia",
      description: "Hospedagem de temporada com espaco completo, cozinha equipada e comodidades para grupos.",
      extra_data: {
        duration: "Minimo de 2 diarias",
        location: "Bairro residencial",
        highlights: ["Casa completa", "Cozinha equipada", "Ideal para familias"],
        included: ["Wi-Fi", "Roupa de cama", "Utensilios de cozinha"],
        not_included: ["Taxa de limpeza se nao descrita", "Consumo extra", "Servicos opcionais"],
        capacity: "6 pessoas",
        bedrooms: "3 quartos",
