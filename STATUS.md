...
- **Mais modelos profissionais:** biblioteca subiu para 9 templates: Turismo Direto, Receptivo Premium, Agencia de Pacotes, Hospedagem Boutique, Resort & Day Use, Aventura Local, Viagens Premium, Cruzeiros & Grupos e Chales & Natureza
...
- **Modelos de Loja editáveis** (`lib/store-templates.ts`) — biblioteca nativa derivada dos projetos em `references/projetos-base/`: Turismo Direto, Receptivo Premium, Agência de Pacotes, Hospedagem Boutique, Resort/Day Use, Aventura Local, Viagens Premium, Cruzeiros & Grupos e Chales & Natureza. No onboarding e no painel Aparência o tenant escolhe um modelo, vê preview em tempo real e pode receber uma cópia editável do tema, seções e primeiro produto
